...
mkdir input_d2_data #Move raw training data into here ##later link this to the mainloop, change dir name
mkdir trim_d2_data
...
python cut_focal_box base_dir.py --focalbox 'bb' --classes 'Leaf100' --classes 'Leaf90'
...
python lm2coco.py temp_trim_d2_data --output trim_d2_validation.json --classes 'Leaf100' --classes 'Leaf90' --polyORbb 'bb'
