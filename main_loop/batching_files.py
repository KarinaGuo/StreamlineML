...
file_list = glob.glob('/home/karina/test_images/*.jpg')
temp_image_subset_dir = os.path.join(args.base_dir, "temp_image_subset_lists")  
...
for img in file_list:
	if ((counter*batch_size)+1) <= image_length:
		...
		out_file_dir = os.path.join(args.base_dir, "temp_image_subset_lists", out_file)
